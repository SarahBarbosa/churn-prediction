# Alura Challenge Data Science 2ª Edição
...
- Realizar pré-processamento dos dados, incluindo a binarização de dados categóricos, para prepará-los para etapas posteriores do projeto.

**Notebook Correspondente:**

- [`S01_Limpeza-analise-exploratoria-dos-dados.ipynb`](https://github.com/SarahBarbosa/AluraDataChallenge_2/blob/main/Semana%2001/S01_Limpeza-analise-explorat%C3%B3ria-dos-dados.ipynb)
